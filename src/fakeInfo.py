...
class FakeData(Faker):
  ...
  def fill_valid_value(self, element):
    ...
    if 'signature' in element_id:
      ...
      return choice(range(10000, 100000))
      ...
      if 'gmat' in element_id or 'gre' in element_id or 'toefl' in element_id or 'ielts' in element_id:
        ...
        return choice(range(400,600))
    elif 'gpa' in element_id:
      random_gpa = Decimal(randint(31, 39))/Decimal(10)
      return str(random_gpa)
  ...
  def _fake_date(self, element):
    ...
    year = choice(range(1950, 2000))
    month = choice(range(1, 12))
    day = choice(range(1, 27))
  ...
  def _get_score(self, element):
    try:
      ...
      if 'percent' in element.get_attribute('id'):
        return choice(range(10, 90))
      elif 'toefl' in element.get_attribute('id'):
        return choice(range(0, 30))
      else:
        return choice(range(300, 600))
